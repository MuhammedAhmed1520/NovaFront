  ...
  <div class="accounts">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>account_balance_wallet</v-icon>All Currency
      </v-toolbar-title>
            ...
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs12 sm12 md6>
                  <v-text-field v-model="editedItem.name" color="teal" label="Currency Name"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md6>
                  <v-text-field v-model="editedItem.name" color="teal" label="Shortcut"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md12>
                    <label for="">Upload PHoto</label>
                  <upload-btn round icon color="teal">
                    <template slot="icon">
