  ...
  <div class="money">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>transform</v-icon>All Discounts
      </v-toolbar-title>
          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6>
                  <v-select
                    :items="['Project', 'Project', 'Project', 'Project']"
                    label="Project"
                    required
                    color="teal"
                  ></v-select>
                ...
                <v-flex xs12 sm12 md12>
                  <v-text-field label="Value" color="teal" hint="Value That Discounts from account"></v-text-field>
                </v-flex>
                <v-flex xs12>
                  <v-textarea
                    name="input-7-1"
