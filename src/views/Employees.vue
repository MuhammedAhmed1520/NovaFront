  ...
  <div class="project-types">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>account_balance_wallet</v-icon>All Employee Data
      </v-toolbar-title>
          ...
          <v-card-text>
            <v-container gr id-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm12 md12>
                  <v-text-field label="Sallary" color="teal"></v-text-field>
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
