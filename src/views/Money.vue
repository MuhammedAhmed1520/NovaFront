  ...
  <div class="money">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>attach_money</v-icon>All Money Transaction
      </v-toolbar-title>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs12 sm6 md6>
                  <v-text-field label="Value" color="teal" hint="Value will be added to Acoount"></v-text-field>
                </v-flex>
                <v-flex xs12 sm6>
                  <v-select
                    :items="['Project1', 'Project2', 'Project3', 'Project4']"
                    label="Project"
                    required
                    color="teal"
                  ></v-select>
                ...
                <v-flex xs12 sm6>
                  <v-select :items="['1', '2', '3', '4']" label="Account" required color="teal"></v-select>
                </v-flex>
                <v-flex xs12>
                  <v-textarea
                    name="input-7-1"
