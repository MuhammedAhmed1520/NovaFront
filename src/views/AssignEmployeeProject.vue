  ...
  <div class="accounts">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>account_balance_wallet</v-icon>All Employee Commission
      </v-toolbar-title>
      ...
      <v-dialog v-model="account_dialog" max-width="800px">
        ...
        <v-card>
          <v-card-title>
            <v-container>
              <v-layout left mt-2>
                <span class="headline">New Assign commission</span>
              </v-layout>
            </v-container>
          </v-card-title>
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs12 sm12>
                  <v-select
                    :items="['Project', 'Project2', 'Project3', 'Project4']"
                ...
                <v-flex xs12 sm6>
                  <v-select :items="['1', '2', '3', '4']" label="Employee" required color="teal"></v-select>
                </v-flex>
                <v-flex xs12 sm6>
                  <v-select :items="['Done', 'Not Done']" label="Status" required color="teal"></v-select>
                </v-flex>

                <v-flex xs12 sm6 md6>
                  <v-text-field label="Commission" color="teal" required></v-text-field>
                </v-flex>
                <v-flex xs12 sm6 md6>
...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "New Assign Commission" : "Edit Assign Commission";
    }
  },
