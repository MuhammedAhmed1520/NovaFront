  ...
  <div class="projects">
    <v-toolbar flat color="white">
      <v-toolbar-title class="subheading grey--text">
        <v-icon>account_balance_wallet</v-icon>All Projects Data
      </v-toolbar-title>
            ...
            <v-container>
              ...
              <v-layout right>
                ...
                <v-dialog right v-model="type_dialog" max-width="500px">
                  <v-btn slot="activator" round color="teal" dark class="mb-2">New Project Type
                    ...
                    <v-card-text>
                      <v-container grid-list-md>
                        <v-layout wrap>
                          ...
                          <v-flex xs12 sm12 md12>
                            <v-text-field v-model="editedItem.name" color="teal" label="Commission"></v-text-field>
                          </v-flex>
                        </v-layout>
                      </v-container>
                    </v-card-text>
          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6>
                  <v-select :items="['1', '2', '3', '4']" label="Client Name" required color="teal"></v-select>
                </v-flex>
                <v-flex xs12 sm6>
                  <v-select
                    :items="['1', '2', '3', '4']"
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field label="Commission" color="teal" hint="Commission of this Project"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field label="Price" color="teal" hint="Total Price"></v-text-field>
                </v-flex>
                ...
                <v-flex xs12 sm6 md6>
                  <v-text-field
                    ...
                    color="teal"
                    hint="Price added To company account"
                  ></v-text-field>
                </v-flex>

                <v-flex xs12 sm6 md6>
                  <v-text-field
                    label="Link On Freelancer"
                    color="teal"
                    hint="The link of project if exsit"
                  ></v-text-field>
                </v-flex>
                <v-flex xs12 sm6 md6>
                  <v-text-field
                    label="Chat Link On Freelancer"
                    color="teal"
                    hint="The link of chat project if exsit"
                  ></v-text-field>
                </v-flex>
                <v-flex xs12 sm12>
                  <v-select
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Project Type", value: "protein" },
      { text: "Commission", value: "protein" },
      { text: "Client", value: "protein" },
      { text: "Start Date", value: "protein" },
      { text: "Emd Date", value: "protein" },
      { text: "Price", value: "protein" },
      { text: "Price after Comission", value: "protein" },
      { text: "Status", value: "protein" },
      { text: "Link On freelancer", value: "protein" },
      { text: "Chat Link", value: "protein" },
